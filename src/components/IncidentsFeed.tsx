    ...
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xl space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-base font-bold text-white">Live Travel Disruptions & Demand Spikes</h3>
            <p className="text-xs text-slate-400">MRT faults, expressway accidents & venue dispersals driving passenger demand</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-800/80">
                <div className="text-xs">
                  <span className="text-slate-400">Demand Catalyst: </span>
                  <strong className="text-amber-400">{incident.surgeImpact}</strong>
                </div>
